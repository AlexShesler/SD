...
namespace SD
{
    public class AD
    {
        ...
        readonly static string sDomain = "corp.tander.ru";
        readonly static string sDefaultOU = "DC=corp,DC=tander,DC=ru";
        readonly static string sDefaultRootOU = "DC=corp,DC=tander,DC=ru";
        public static string sServiceUser, sServicePassword;

        /// <summary>
        /// Устанавливает логин и пароль пользователя
        /// </summary>
        /// <param name="ServiceUser">Имя пользователя с правами на на редактирование</param>
        /// <param name="ServicePassword">Пароль пользователя</param>
        /// <returns>Устанавливает переменные домена</returns>
        public static void SetUserData(string ServiceUser, string ServicePassword)
        {
        ...
        /// <summary>
        /// Получить имя указанного пользователя Active Directory
        /// </summary>
        /// <param name="sUserName">Имя пользователя для извлечения</param>
        /// <returns>Объект UserPrincipal</returns>
        //public static UserPrincipal GetUserName(string sUserName)
        //{
        ...
        {
            return GetUser(sUserName).DisplayName.ToString();
        }
        ...
        public static string SetUserPassword(string sUserName, string sNewPassword)//, out string sMessage)
        {
            try
            {
